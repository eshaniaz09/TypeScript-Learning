...
const accountNumber: number = 2244;
const yourPin: number = 99;
let totalBalance: number = 12000;
const withdrawAmount: number = 11000;
...
// my second approach 
let smallest_numb : number = Math.min(numb1, numb2, numb3, numb4, numb5);

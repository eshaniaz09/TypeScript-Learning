...
let truthFalse = [true, false, true, false, false];
let data3 = 2;
...
let studentsNames = ['esha', 'tehzeeb', 'umer', 'ayyan', 'waleed'];
...
let newArray = ['hello', 'esha', 'you', 'are', 'great'];
...
//7 - sort()
let sortNumbers = [12, 34, 23, 1, 65, 88, 99, 46];

...
const fetchQuiz = async () => {
    try {
        ...
        let questions: Question[] = await jsonData.results;
        let questionAnswers: QuestionAnswers[] | undefined = questions.map(question => ({ question: question.question, options: [...question.incorrect_answers, question.correct_answer], correct: question.correct_answer }))
